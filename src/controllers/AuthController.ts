...
export class AuthController {
    static createAccount = async (req: Request, res: Response) => {
        try {
            ...
            res.send('Usuario creado, por favor revisa tu correo para confirmar tu cuenta');
    ...
    static login = async (req: Request, res: Response) => {
        try {
            ...
            if(!user.confirmed) {
                ...
                const error = new Error('Cuenta no confirmada, hemos enviado un nuevo correo de confirmación')
